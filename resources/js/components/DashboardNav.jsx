...
function NavBar({user}) {
    return ( 
        <>
            ...
            <p className="text-sm md:text-lg lg:text-xl pl-1 group"><FontAwesomeIcon icon={faUser} size="lg" /> <span className="ml-3 hidden md:inline group-hover:inline">Hello, {user?.name}</span></p>
                        <ul className="mt-5">
